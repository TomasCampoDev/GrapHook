...
public class PlayerController : MonoBehaviour, IPlayerContext
{
    ...
    private void UpdateAimTransition()
    {
        ...
        // Ya no hay compensación de yaw. No hace falta.
    }
    private void UpdateCameraPosition()
    {
        ...
        // El pivote de la órbita es el personaje desplazado lateralmente
        Vector3 orbitPivot = transform.position
                           + Vector3.up * _currentHeightOffset
                           + cameraRight * _currentShoulderOffset;

        // La cámara orbita alrededor del pivote, no alrededor del personaje
        ...
        // Miramos siempre al pivote → la rotación es coherente con la órbita
